<div class="row">
    ...
    <div class="col-md-6 mb-5">
        ...
        {{ Form::text('jotform_link', null,['class' => 'form-control jotform-link-input','placeholder' => 'https://form.jotform.com/...  or paste full <iframe> code', 'id' => 'jotform_link']) }}
            ...
            <div class="mb-3" io-image-input="true">
                ...
                <div class="d-block">
                    <div class="image-picker">
                        <div class="image previewImage" id="exampleInputImage" style="background-image: url({{ !empty($service->icon) ? $service->icon : asset('web/media/avatars/male.jpg') }})">
                        </div>
