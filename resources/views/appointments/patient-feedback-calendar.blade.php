    ...
    <div class="container-fluid">
        <div class="d-md-flex align-items-center justify-content-between mb-5">
            ...
            <div class="text-end mt-4 mt-md-0">
                <a href="{{ route('patients.patient-bookings-feedback') }}"
            ...
            <div class="flex-lg-row-fluid">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div id="patientFeedbackAppointmentCalendar"></div>
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('appointments.models.patient-feedback-appointment-model')
@endsection
