<div class="d-flex">
   <div class="align-items-center me-4 me-md-2">
      <input type="text" class="form-control form-control-solid custom-width px-3 flatpickr-input"  placeholder="{{ __('messages.common.pick_date_range') }}" id="appointmentDateFilter"/>
  </div>
