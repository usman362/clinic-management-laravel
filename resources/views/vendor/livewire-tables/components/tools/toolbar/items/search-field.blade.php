    ...
    <form class="d-flex position-relative">
        <div class="position-relative d-flex width-320">
          <span
            ...
            <input class="form-control search-box ps-8" wire:model{{ $component->getSearchOptions() }}="search" type="search" placeholder="{{__('messages.common.search')}}" aria-label="Search">
        </div>
    </form>
