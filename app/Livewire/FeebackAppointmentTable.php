...
class FeebackAppointmentTable extends LivewireTableComponent
{
    ...
    public array $FilterComponent = ['feedback_appointments.components.filter', Appointment::PAYMENT_TYPE_ALL, Appointment::STATUS];
    ...
    {
        $query = Appointment::where('appointment_type','feedback')->with([
            'doctor.user',
            'patient.user',
            'services',
            'transaction',
