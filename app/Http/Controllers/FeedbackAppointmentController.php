...
use App\Repositories\FeedbackAppointmentRepository;
...
class FeedbackAppointmentController extends AppBaseController
{
    /** @var FeedbackAppointmentRepository */
    private $appointmentRepository;

    public function __construct(FeedbackAppointmentRepository $appointmentRepo)
    {
    ...
    public function index(): \Illuminate\View\View
    {
        ...
        return view('feedback_appointments.index', compact('allPaymentStatus', 'paymentGateway', 'paymentStatus'));
    }
    ...
    public function show(Appointment $appointment)
    {
        ...
        if (getLogInUser()->hasRole('patient')) {
            ...
            return view('feedback_appointments.show')->with('appointment', $appointment)
    ...
    public function patientAppointmentCalendar(Request $request)
    {
        ...
        return view('feedback_appointments.patient-calendar');
    }
    ...
    public function appointmentCalendar(Request $request)
    {
        ...
        return view('feedback_appointments.calendar');
    }
