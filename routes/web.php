...
Route::prefix('admin')->middleware('auth', 'xss', 'checkUserStatus', 'checkImpersonateUser')->group(function () {
    ...
    Route::middleware('permission:manage_patients')->group(function () {
        ...
        Route::post('appointment-comments/{id}',[PatientController::class,'postComments'])->name('store.appointment_comments');
        Route::get(
            'patient-appointments',
            [PatientController::class, 'patientAppointment']
        )->name('patients.appointment');

        Route::post('/documents/{id}', [PatientController::class, 'uploadDocument'])
    ...
    //     dd(class_exists(\App\Http\Controllers\AppointmentController::class));
    // });
    Route::get(
        'package-details/{id}',
    ...
    Route::get(
        'admin-feedback-appointments-calendar',
        [FeedbackAppointmentController::class, 'appointmentCalendar']
    )->name('feedback-appointments.calendar');
